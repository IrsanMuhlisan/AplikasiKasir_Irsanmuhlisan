...
public class FormAbout extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/bigmart2 (1).png"))); // NOI18N

        jLabel1.setText("Aplikasi Kasir dapat meningkatkan Akurasi dan Efisiensi Transaksi dan");

        jLabel3.setText("meningkatkan keamanan data dengan mudah.");

        jLabel4.setText("Versi                : 1.0");

        jLabel5.setText("Dibuat Oleh  : Irsan Muhlisan dan novita");
